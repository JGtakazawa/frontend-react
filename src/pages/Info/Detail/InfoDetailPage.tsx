    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex-1 p-6">
                <h1 className="text-3xl font-semibold text-gray-900 mb-6 text-center">インフォメーション詳細</h1>
                {data === null ? (
                    <NoDataMessage message="インフォメーション詳細情報が見つかりませんでした" />
                ) : (
                    <InfoDetailList info={data.info} files={data.infoFiles} urls={data.infoUrls} />
                )}
            </div>
        </div>
    );
